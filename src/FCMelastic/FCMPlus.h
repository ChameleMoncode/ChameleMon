...
{
public:
	HeavyPart * heavy_part[FCMPLUS_HEAVY_STAGE] = {NULL};
...
public:
	FCMPlus(){
		...
		uint32_t total_memory = FCMPLUS_BUCKET * FCMPLUS_HEAVY_STAGE * (20); // key, val, val_all => 20 bytes in Tofino (with 2 times duplicated storage of key-value)
